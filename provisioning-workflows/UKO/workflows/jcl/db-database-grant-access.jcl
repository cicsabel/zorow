...
GRANT SELECT ON MSDKE_KEYSTORES TO &WEBUSER;
GRANT INSERT ON MSDKE_KEYSTORES TO &WEBUSER;
GRANT UPDATE ON MSDKE_KEYSTORES TO &WEBUSER;
GRANT DELETE ON MSDKE_KEYSTORES TO &WEBUSER;

GRANT SELECT ON MSDKE_KEYS TO &WEBUSER;
GRANT INSERT ON MSDKE_KEYS TO &WEBUSER;
GRANT UPDATE ON MSDKE_KEYS TO &WEBUSER;
GRANT DELETE ON MSDKE_KEYS TO &WEBUSER;

GRANT SELECT ON VTSAUDIT2 TO &WEBUSER;
GRANT INSERT ON VTSAUDIT2 TO &WEBUSER;

-- V3.1.0.8

GRANT SELECT ON BACKGROUND_JOBS TO &WEBUSER;
GRANT INSERT ON BACKGROUND_JOBS TO &WEBUSER;
GRANT UPDATE ON BACKGROUND_JOBS TO &WEBUSER;
GRANT DELETE ON BACKGROUND_JOBS TO &WEBUSER;

-- V3.1.0.9

GRANT SELECT ON ACSP_SERVERS TO &WEBUSER;
GRANT INSERT ON ACSP_SERVERS TO &WEBUSER;
GRANT UPDATE ON ACSP_SERVERS TO &WEBUSER;
GRANT DELETE ON ACSP_SERVERS TO &WEBUSER;

-- V3.1.0.10

GRANT SELECT ON BATCH_JOB_ITEMS TO &WEBUSER;
GRANT INSERT ON BATCH_JOB_ITEMS TO &WEBUSER;
GRANT UPDATE ON BATCH_JOB_ITEMS TO &WEBUSER;
GRANT DELETE ON BATCH_JOB_ITEMS TO &WEBUSER;

GRANT SELECT ON EKMF_WEB_KEY_ALL_TAGS TO &WEBUSER;

GRANT SELECT ON MSDKE_KEYS_USERS TO &WEBUSER;
GRANT INSERT ON MSDKE_KEYS_USERS TO &WEBUSER;
GRANT UPDATE ON MSDKE_KEYS_USERS TO &WEBUSER;
GRANT DELETE ON MSDKE_KEYS_USERS TO &WEBUSER;
/*
