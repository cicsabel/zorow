...
KEYRING_OWNER="${instance-SERVER_TLS_KEY_STORE_OWNER}"

Say "RDATALIB definitions: "
/* Enable the Liberty user to use the key ring */
Say "Define" KEYRING_OWNER"."TLS_KEY_STORE_KEY_RING".LST"
"RDEFINE RDATALIB",
   KEYRING_OWNER"."TLS_KEY_STORE_KEY_RING".LST",
...
Say "Define" KEYRING_OWNER"."TLS_TRUST_STORE_KEY_RING".LST"
"RDEFINE RDATALIB",
   KEYRING_OWNER"."TLS_TRUST_STORE_KEY_RING".LST",
   " OWNER("SAF_OWNER") UACC(NONE)"
