...
"RDEFINE EJBROLE" SAFPREFIX".ekmf-rest-api."VAULT_ID".keys:write:exportControl:allowedKeys:add OWNER("SAF_OWNER") UACC(NONE)"
"RDEFINE EJBROLE" SAFPREFIX".ekmf-rest-api."VAULT_ID".keys:write:exportControl:allowedKeys:remove OWNER("SAF_OWNER") UACC(NONE)"
...
"PERMIT" SAFPREFIX".ekmf-rest-api."VAULT_ID".keys:write:exportControl:allowedKeys:add CLASS(EJBROLE) ACCESS(READ) ID("ZKEY_GROUP")"
"PERMIT" SAFPREFIX".ekmf-rest-api."VAULT_ID".keys:write:exportControl:allowedKeys:remove CLASS(EJBROLE) ACCESS(READ) ID("ZKEY_GROUP")"
