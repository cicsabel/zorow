...
if [ ! -d "${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}" ]; then
    echo "Creating server directory ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}"
    mkdir -p ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}
    if [ $? -gt 0 ]; then 
        echo "ERROR: Could not create directory" >&amp;2;
        exit "2"; 
    fi
    echo "changing access to 755"
    chmod 755 ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}
fi
...
if [ -z "${mountvalue}" ]; then
    echo "Running command: mount -t ZFS -f ${zfs} ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}"
    mount -t ZFS -f ${zfs} ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}
else
    echo "Running command: mount -t ZFS -a ${d}mountvalue -f ${zfs} ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}"
    mount -t ZFS -a ${d}mountvalue -f ${zfs} ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}
fi
...
mkdir ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}/PROVISION_OK
chmod 755 ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}
#if(${instance-SERVER_STC_GROUP} != "" && ${instance-SERVER_STC_GROUP})
chown ${instance-SERVER_STC_USER}:${instance-SERVER_STC_GROUP} ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}
#else
#if(${instance-SERVER_STC_USER} != ${instance-CC_ADMIN_ZFS})
chown ${instance-SERVER_STC_USER} ${instance-SERVER_USER_DIR}/${instance-SERVER_STC_NAME}
#end
#end
...
chmod 755 ${instance-SERVER_OUTPUT_DIR}/${instance-SERVER_STC_NAME}
#if(${instance-SERVER_STC_GROUP} != "" && ${instance-SERVER_STC_GROUP})
chown ${instance-SERVER_STC_USER}:${instance-SERVER_STC_GROUP} ${instance-SERVER_OUTPUT_DIR}/${instance-SERVER_STC_NAME}
#else
#if(${instance-SERVER_STC_USER} != ${instance-CC_ADMIN_ZFS})
chown ${instance-SERVER_STC_USER} ${instance-SERVER_OUTPUT_DIR}/${instance-SERVER_STC_NAME}
#end
#end
