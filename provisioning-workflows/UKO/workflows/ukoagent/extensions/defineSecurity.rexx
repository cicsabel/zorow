...
"RDEFINE APPL KMGPRACF UACC(NONE) OWNER("SAF_OWNER")"
...
"RDEFINE FACILITY KMG.EKMF.KMGPRACF UACC(NONE) OWNER("SAF_OWNER")"
...
"RDEFINE FACILITY KMG.EKMF.KMGPRACF."AGENT_STC_USER "UACC(NONE) OWNER("SAF_OWNER")"
Say "Granting access to web client user" AGENT_CLIENT_GROUP
"PERMIT KMG.EKMF.KMGPRACF."AGENT_STC_USER "CLASS(FACILITY) ",
   " ID("AGENT_CLIENT_GROUP") ACCESS(READ)"
...
"RDEFINE FACILITY KMG.EKMF.SMF OWNER("SAF_OWNER") UACC(NONE) AUDIT(ALL(READ))"
...
"RDEFINE FACILITY KMG.EKMF.AUDITOFF OWNER("SAF_OWNER") UACC(NONE) AUDIT(ALL(READ))"
