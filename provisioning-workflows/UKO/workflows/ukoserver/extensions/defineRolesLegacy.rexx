...
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:active:change_expiration UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:active:deactivate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:active:install UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:active:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:active:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:active:update UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:compromised:destroy UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:compromised:install UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:compromised:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:compromised:unmark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:compromised:update UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:deactivated:destroy UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:deactivated:install UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:deactivated:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:deactivated:reactivate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:deactivated:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:destroyed_compromised:remove UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:destroyed:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:destroyed:remove UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:distribute UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:export UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:generate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:non_existing:generate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:non_existing:import UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:pre_activation:activate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:pre_activation:change_expiration UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:pre_activation:destroy UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:pre_activation:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:pre_activation:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:pre_activation:update UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:read UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:write UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:delete UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:write:dates UACC(NONE)"
...
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keys:write:tags UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keystores:read UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keystores:write UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.keystores:delete UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.logs:read UACC(NONE)"
...
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.templates:read UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api.templates:write UACC(NONE)"
