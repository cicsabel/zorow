...
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:active:deactivate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:active:install UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:active:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:active:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:compromised:destroy UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:compromised:install UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:compromised:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:compromised:unmark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:deactivated:destroy UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:deactivated:install UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:deactivated:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:deactivated:reactivate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:deactivated:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:destroyed:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:non_existing:generate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:non_existing:import UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:pre_activation:activate UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:pre_activation:destroy UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:pre_activation:mark_compromised UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:pre_activation:uninstall UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:write:dates UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:write:tags UACC(NONE)"

"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:delete UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:read UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:write UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keystores:delete UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keystores:read UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keystores:write UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".templates:delete UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".templates:read UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".templates:write UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".vaults:delete UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".vaults:read UACC(NONE)"
"RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".vaults:write UACC(NONE)"

/* roles that have been removed in the transition from v2 to v4, replaced with keys:write */
/* "RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:distribute UACC(NONE)" */
/* "RDEFINE EJBROLE "||SAFPREFIX||".ekmf-rest-api."||VAULT_ID||".keys:generate UACC(NONE)" */
