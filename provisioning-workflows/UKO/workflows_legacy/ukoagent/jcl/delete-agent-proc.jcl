...
//SYSTSIN     DD    *
 ...
 DELETE '${instance-ZOS_PROCLIB}(${instance-AGENT_STC_NAME})' FILE(DD1)
 FREE FILE(DD1)
 ALLOCATE FILE(DD1) DATASET('${instance-ZOS_PARMLIB}') SHR
 DELETE '${instance-ZOS_PARMLIB}(${instance-AGENT_STC_NAME})' FILE(DD1)
 FREE FILE(DD1)
 ...
 DELETE '${instance-ZOS_STCJOBS}(${instance-AGENT_STC_NAME})' FILE(DD2)
 FREE FILE(DD2)
#end
#end
/*